    ...
    return (
        ...
        <div className="overflow-hidden mt-7 lg:mt-11 flex flex-col items-center w-full p-4 lg:p-5 border border-mid-blue rounded-3xl hover:bg-white/3 transition">
            ...
            <div className="flex justify-center items-center">
                <div className="flex-col items-center text-sm lg:text-base justify-center">
                ...
                <Image src={meetingData.circuit_image} width={138} height={100} className="w-[110px] h-[80px] lg:w-[138px] lg:h-[100px] "alt={`${meetingData.circuit_short_name} circuit`}/>
            </div>
        </div>}
        </>
    )
